							...
							<div class="d-flex ml-auto header-right-icons header-search-icon">
								...
								<div class="dropdown profile-1">
									...
									<div class="dropdown-menu dropdown-menu-right">
										...
										<!-- <a href="#" class="dropdown-item" data-toggle="modal" data-target="#editarCampanaModal">
											<i class="dropdown-icon zmdi zmdi-edit"></i> Editar campaña existente
										</a> -->
									</div>
								</div>
								...
								<div class="dropdown profile-1">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
										...
										<a class="dropdown-item" href="#">
											<i class="dropdown-icon zmdi zmdi-edit"></i> Editar perfil
										</a>
										<a class="dropdown-item" href="#">
											<i class="dropdown-icon  mdi mdi-settings"></i> Ajuste cuenta
										</a>
										<a class="dropdown-item" href="#">
